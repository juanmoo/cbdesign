...
def validate(plan: Plan) -> tuple[dict, object | None]:
    ...
    try:
        ...
        return ({"status": "invalid", "scope": "M1 nominal geometry and declared-profile checks only", "coverage": {"passed": [], "failed": [error.diagnostic], "not_evaluated": not_evaluated}}, None)
